...
type AdminOrder = {
  ...
  payments?: Array<{ id: string; method: string; status: string; transferSlips: Array<{ id: string; status: string; createdAt: string }> }>;
};
