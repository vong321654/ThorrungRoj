...
type DebtRecord = {
  id: string; orderId: string | null; debtType: "money" | "cart"; amount: number | string; status: "pending" | "partial" | "paid"; createdAt: string;
